	...
	for i_elem = 1 : m
		...
		if (( (vertex_coords(1, 1) == 0) && (vertex_coords(1, 2) == 0) ) ...  % on x == 0
		 ...
		 || ( (vertex_coords(2, 1) == 1) && (vertex_coords(2, 2) == 1) ))     % on y == 1
			b2(elem_vertex_ids) = b2(elem_vertex_ids) + fem2d_quad_bilin_int_g(vertex_coords, 1, 2);
		end
		...
		if (( (vertex_coords(1, 2) == 0) && (vertex_coords(1, 3) == 0) ) ...  % on x == 0
		 ...
		 || ( (vertex_coords(2, 2) == 1) && (vertex_coords(2, 3) == 1) ))     % on y == 1 
			b2(elem_vertex_ids) = b2(elem_vertex_ids) + fem2d_quad_bilin_int_g(vertex_coords, 2, 3);
		end
		
		if (( (vertex_coords(1, 3) == 0) && (vertex_coords(1, 4) == 0) ) ...  % on x == 0
		 || ( (vertex_coords(1, 3) == 1) && (vertex_coords(1, 4) == 1) ) ...  % on x == 1
		 || ( (vertex_coords(2, 3) == 0) && (vertex_coords(2, 4) == 0) ) ...  % on y == 0
		 || ( (vertex_coords(2, 3) == 1) && (vertex_coords(2, 4) == 1) ))     % on y == 1
			b2(elem_vertex_ids) = b2(elem_vertex_ids) + fem2d_quad_bilin_int_g(vertex_coords, 3, 4);
		end
		
		if (( (vertex_coords(1, 4) == 0) && (vertex_coords(1, 1) == 0) ) ...  % on x == 0
		 || ( (vertex_coords(1, 4) == 1) && (vertex_coords(1, 1) == 1) ) ...  % on x == 1
		 || ( (vertex_coords(2, 4) == 0) && (vertex_coords(2, 1) == 0) ) ...  % on y == 0
		 || ( (vertex_coords(2, 4) == 1) && (vertex_coords(2, 1) == 1) ))     % on y == 1
			b2(elem_vertex_ids) = b2(elem_vertex_ids) + fem2d_quad_bilin_int_g(vertex_coords, 4, 1);
		end
	end
